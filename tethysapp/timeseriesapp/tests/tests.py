    ...
    4. Enter tethys test command.
       ...
       See below for specific examples
        ...
        To run all tests across this app:
            Test command: "tethys test -f tethys_apps.tethysapp.timeseriesapp"

        To run all tests in this file:
            Test command: "tethys test -f tethys_apps.tethysapp.timeseriesapp.tests.tests"

        To run tests in the TimeseriesappTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.timeseriesapp.tests.tests.TimeseriesappTestCase"

        To run only the test_if_tethys_platform_is_great function in the TimeseriesappTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.timeseriesapp.tests.tests.TimeseriesappTestCase.test_if_tethys_platform_is_great"
...
class TimeseriesappTestCase(TethysTestCase):
    """
    ...
    def set_up(self):
        ...
        test database creation function here, like so:
            ...
            self.create_test_persistent_stores_for_app(Timeseriesapp)
    ...
    def tear_down(self):
        ...
        stores, you should call the test database destruction function from here, like so:
            ...
            self.destroy_test_persistent_stores_for_app(Timeseriesapp)
    ...
    def test_home_controller(self):
        ...
        response = c.get('/apps/timeseriesapp/')  # The final '/' is essential for all pages/controllers
